  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      <ModalContent borderRadius={0}>
        <ModalHeader color="#454545">Verification Required</ModalHeader>
            ...
            <div className="flex flex-row justify-between my-5">
              {code.map((digit, index) => (
                <input
                  ...
                  className="w-10 h-[50px] text-2xl text-center peer transition-all duration-300 focus:border-none block outline outline-2 outline-[#e3e3e3] py-[13.5px] px-[11px] focus:outline-2 focus:outline-primary text-[#9D9D9D]"
                  type="text"
                  maxLength={1}
                  value={digit}
        ...
        <ModalFooter justifyContent="space-between" display="flex" width="100%">
          <div className="text-[14px] font-normal text-[#9d9d9d]">
            Didn&apos;t receive code?
            <Button
            ...
            {isResendDisabled && (
              <Text fontSize="12px" color="#454545">
